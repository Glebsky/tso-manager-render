...
class ScheduledTaskResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'task_type' => $this->task_type instanceof \BackedEnum ? $this->task_type->value : $this->task_type,
            'schedule_type' => $this->schedule_type instanceof \BackedEnum ? $this->schedule_type->value : $this->schedule_type,
