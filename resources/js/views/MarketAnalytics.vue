                ...
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <div class="glass-card p-4 sm:p-6">
                        ...
                        <div class="space-y-4 sm:space-y-5">
                            <div>
                                <label for="admin-calc-amount-input" class="block text-xs font-medium text-white/40 mb-1.5 sm:mb-2 uppercase tracking-wider">{{ t('market.amount_of', { item: selectedItemName }) }}</label>
                                <input id="admin-calc-amount-input" type="number" v-model.number="calcAmount" min="1" :aria-label="t('market.amount_of', { item: selectedItemName })" class="glass-input w-full font-mono text-white text-base sm:text-lg"/>
                            </div>
                            ...
                            <div v-if="mirroredStats" class="p-3.5 sm:p-4 rounded-xl border border-blue-500/10 bg-blue-500/[0.02]">
