    ...
    <div>
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-white/40 mt-1">{{ currentDate }}</p>
            </div>
            <div class="flex items-center gap-3">
                <button @click="loadData" :disabled="loading" class="btn-secondary flex items-center gap-2 disabled:opacity-50">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
            ...
            <template v-else>
                ...
                <div class="glass-card p-5 group hover:border-white/20 transition-all duration-500 animate-fade-in-up" style="animation-delay: 0ms">
                    ...
                    <p class="text-xs text-white/30 mt-1">{{ t('dashboard.registered_accounts') }}</p>
                </div>
                ...
                <div class="glass-card p-5 group hover:border-white/20 transition-all duration-500 animate-fade-in-up" style="animation-delay: 80ms">
                    ...
                    <p class="text-xs text-white/30 mt-1">{{ t('dashboard.scheduled_tasks') }}</p>
                </div>
                ...
                <div class="glass-card p-5 group hover:border-white/20 transition-all duration-500 animate-fade-in-up" style="animation-delay: 160ms">
                    ...
                    <p class="text-xs text-white/30 mt-1">{{ t('dashboard.actions_executed') }}</p>
                </div>
                ...
                <div class="glass-card p-5 group hover:border-white/20 transition-all duration-500 animate-fade-in-up" style="animation-delay: 240ms">
                    ...
                    <p class="text-xs text-white/30 mt-1">{{ t('dashboard.error_count') }}</p>
                </div>
            </template>
        </div>
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-5">
                ...
                <router-link to="/accounts" class="text-sm text-emerald-400 hover:text-emerald-300 transition-colors flex items-center gap-1">
            ...
            <div v-else class="glass-card p-12 text-center">
                ...
                <p class="text-white/30 text-sm mb-4">{{ t('dashboard.no_accounts_hint') }}</p>
                <router-link to="/accounts" class="btn-primary inline-flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <div>
            <div class="flex items-center justify-between mb-5">
                ...
                <router-link to="/logs" class="text-sm text-teal-400 hover:text-teal-300 transition-colors flex items-center gap-1">
            ...
            <div class="glass-card overflow-hidden">
                ...
                <div v-else class="p-8 text-center">
                    <p class="text-white/30 text-sm">{{ t('dashboard.no_logs') }}</p>
                </div>
            </div>
        </div>
    </div>
