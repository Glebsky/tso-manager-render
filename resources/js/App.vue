<template>
    <div class="relative z-10 flex h-full">
        ...
        <!-- SIDEBAR -->
        <aside v-if="showSidebar" class="glass-sidebar w-64 flex-shrink-0 flex flex-col h-full fixed left-0 top-0 z-30">
            <!-- Logo -->
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <!-- Accounts -->
                <router-link to="/admin/accounts" class="nav-link" :class="{ active: $route.path.startsWith('/admin/accounts') }">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <!-- Market Analytics -->
                <router-link to="/admin/market" class="nav-link" :class="{ active: $route.path === '/admin/market' }">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <main :class="[showSidebar ? 'ml-64' : '', 'flex-1 min-h-full flex flex-col']">
            ...
            <div :class="[showSidebar ? 'p-8' : ($route.meta.guest ? 'p-0' : 'p-4 md:p-8'), 'flex-1 overflow-y-auto']">
