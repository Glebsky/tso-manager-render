    ...
    <div class="relative z-10 flex h-full min-h-screen">
        ...
        <aside v-if="showSidebar"
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                <p class="px-4 text-[10px] font-semibold uppercase tracking-widest text-white/20 mb-3">{{ t('nav.main_menu') }}</p>
                ...
                <router-link to="/admin/accounts" @click="mobileMenuOpen = false" class="nav-link" :class="{ active: $route.path.startsWith('/admin/accounts') }">
                    ...
                    <span class="font-medium">{{ t('nav.accounts') }}</span>
                </router-link>
                ...
                <router-link to="/admin/tasks" @click="mobileMenuOpen = false" class="nav-link" :class="{ active: $route.path === '/admin/tasks' }">
                    ...
                    <span class="font-medium">{{ t('nav.task_planner') }}</span>
                </router-link>
                ...
                <router-link to="/admin/logs" @click="mobileMenuOpen = false" class="nav-link" :class="{ active: $route.path === '/admin/logs' }">
                    ...
                    <span class="font-medium">{{ t('nav.logs') }}</span>
                </router-link>

                <div class="pt-4">
                    <p class="px-4 text-[10px] font-semibold uppercase tracking-widest text-white/20 mb-3">{{ t('nav.market_analytics') }}</p>
                </div>
                ...
                <router-link to="/admin/market" @click="mobileMenuOpen = false" class="nav-link" :class="{ active: $route.path === '/admin/market' }">
                    ...
                    <span class="font-medium">{{ t('nav.market_analytics') }}</span>
                </router-link>

                <div class="pt-4">
                    <p class="px-4 text-[10px] font-semibold uppercase tracking-widest text-white/20 mb-3">{{ t('nav.system') }}</p>
                </div>
